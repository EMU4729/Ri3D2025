...
public class TeleopProvider {
  ...
  private final Command teleopArcade = new TeleopDriveArcade(DriveConstants.PILOT_SETTINGS);
  private final Command teleopDemoArcade = new TeleopDriveArcade(DriveConstants.DEMO_SETTINGS);
