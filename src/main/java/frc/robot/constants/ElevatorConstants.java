...
public class ElevatorConstants {
  ...
  public static final int ENCODER_COUNTS_PER_REV = 2048;// 8192;
  ...
  public static final double GROUND_TO_RAMP_METERS = Units.inchesToMeters(30);
  ...
  public static class HEIGHTS {
    ...
    public static double CORAL_L1 = Units.inchesToMeters(32) - GROUND_TO_RAMP_METERS;//Units.inchesToMeters(18) - GROUND_TO_RAMP_METERS;
    public static double CORAL_L2 = Units.inchesToMeters(35) - GROUND_TO_RAMP_METERS;
    public static double CORAL_L3 = Units.inchesToMeters(65) - GROUND_TO_RAMP_METERS;
    public static double ALGAE_PROCESSOR = 0.0;
    public static double ALGAE_L2 = Units.inchesToMeters(35) - GROUND_TO_RAMP_METERS;
    public static double ALGAE_L3 = Units.inchesToMeters(60) - GROUND_TO_RAMP_METERS;
  }
