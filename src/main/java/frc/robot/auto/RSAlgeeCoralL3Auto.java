        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                new TurnAndDriveToPose(new Translation2d(5.705, AutoConstants.AutoPoints.START_RIGHT.getY()), 
                                    0.5, maxTurn, 0.2, Rotation2d.fromDegrees(3)),
                new ActivateAlgaeL2(true)
            ),
            new TurnToAngle(Rotation2d.fromDegrees(120), maxTurn, Rotation2d.fromDegrees(3)),
            new DriveToPose(AutoConstants.AutoPoints.REEF_FAR_RIGHT, 0.5, maxTurn, 0.1),
            new DriveAtAngle(-0.5, maxTurn, Rotation2d.fromDegrees(120), 1000),
            new InstantCommand(()->Subsystems.algaeArm.setTargetAngle(AlgaeArmConstants.ANGLES.STOW)),
            new ActivateCoralL3(true),
            new TurnToAngle(Rotation2d.fromDegrees(300), maxTurn, Rotation2d.fromDegrees(3)),
            new DriveAtAngle(-0.4, maxTurn, Rotation2d.fromDegrees(300), 1500),
            new DriveAtAngle(0.4, maxTurn, Rotation2d.fromDegrees(300), 1000),
            new TurnAndDriveToPose(new Translation2d(AutoConstants.AutoPoints.PROCESSOR.getX(), 
                                                     ...
                                                     0.5, maxTurn, 0.2, Rotation2d.fromDegrees(3)),
            new TurnAndDriveToPose(AutoConstants.AutoPoints.PROCESSOR, 0.5, maxTurn, 0.2, Rotation2d.fromDegrees(3)),
